<div class="dashboard">
  ...
  <?php endif; ?>
  <form method="post" action="<?= ROOT ?>/admin/campaign/<?= $campaign->campaignIdentify ?>/update" enctype="multipart/form-data">
    <div class="form-grid">
    <div class="form-group">
      <label for="campaignTitle">Campaign Title</label>
      <input type="text" id="campaignTitle" name="campaignTitle" value="<?= $campaign->campaignTitle ?? "" ?>" >
    </div>
    <div class="form-group">
      <label for="campaignSlogan">Campaign Slogan</label>
      <input type="text" id="campaignSlogan" name="campaignSlogan" value="<?= $campaign->campaignSlogan ?? "" ?>" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="campaignAction" name="campaignAction" value="<?= $campaign->campaignAction ?? "" ?>" >
    </div>
    </div>
